...
public class Teller {
	 ...
	 * @throws UnknownHostException Si la banque ne peut pas etre trouvee sur le reseau
	 */
	public Teller(int bankId) throws UnknownHostException {
		if (bankId < 0 || bankId > Config.banksAddresses.length - 1)
			throw new IllegalArgumentException("No de banque invalide pour le guichetier !");
